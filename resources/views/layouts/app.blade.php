...
<body class="font-sans antialiased {{ app()->getLocale() === 'ar' ? 'rtl' : '' }}">
            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-2 sm:space-x-4 {{ app()->getLocale() === 'ar' ? 'space-x-reverse' : '' }}">
                        ...
                        <!-- Mobile Menu Button -->
                        <button id="appMobileMenuButton" class="sm:hidden p-2 text-gray-700 hover:text-blue-600 focus:outline-none" onclick="toggleAppMobileMenu()">
                ...
                <div id="appMobileMenu" class="hidden sm:hidden pb-4 border-t border-gray-200">
    ...
    function toggleAppMobileMenu() {
        const menu = document.getElementById('appMobileMenu');
        if (menu) {
